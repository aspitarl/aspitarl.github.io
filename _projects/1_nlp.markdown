...
I am interested in leveraging artificial intelligence, specifically natural language processing, to extract insights from the scientific literature. My goal is to be able to gain a big-picture view of the field to better direct research efforts and investments toward more promising technologies. I am also interested in developing these codes into accessible tools that can be utilized by other scientists and entrepreneurs.
